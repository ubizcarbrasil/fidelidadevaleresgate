...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { brand_id, branch_id, api_key, receipt_api_key, basic_auth_user, basic_auth_password, action, matrix_api_key, matrix_basic_auth_user, matrix_basic_auth_password } = body;
