...
// ─── Demo Stores Data ────────────────────────────────────────────────
interface DemoStore {
  name: string; slug: string; segment: string; description: string;
  store_type: "RECEPTORA" | "EMISSORA" | "MISTA"; color: string;
  offers: { title: string; coupon_type: "PRODUCT" | "STORE"; discount_percent: number; value_rescue: number; image_url: string; description: string }[];
...
const DEMO_STORES: DemoStore[] = [
  ...
  { name: "Barbearia Premium", slug: "barbearia-premium", segment: "Barbearia", description: "Cortes masculinos clássicos e modernos com atendimento VIP.", store_type: "RECEPTORA", color: "37474F",
    offers: [{ title: "Corte + Barba por R$45", coupon_type: "PRODUCT", discount_percent: 25, value_rescue: 45, image_url: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=400&h=300&fit=crop", description: "Combo corte masculino com barba" }],
  },
  ...
  { name: "Farmácia Saúde+", slug: "farmacia-saude-mais", segment: "Farmácia", description: "Medicamentos, perfumaria e produtos de saúde com os melhores preços.", store_type: "RECEPTORA", color: "1B5E20",
    offers: [{ title: "10% OFF em perfumaria", coupon_type: "STORE", discount_percent: 10, value_rescue: 25, image_url: "https://images.unsplash.com/photo-1631729371254-42c2892f0e6e?w=400&h=300&fit=crop", description: "Desconto em toda linha de perfumaria" }],
  },
  ...
  { name: "Padaria Pão Quente", slug: "padaria-pao-quente", segment: "Padaria", description: "Pães frescos, bolos, salgados e cafés especiais toda manhã.", store_type: "RECEPTORA", color: "F9A825",
    offers: [{ title: "Café + Pão na Chapa R$7,90", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 10, image_url: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=300&fit=crop", description: "Combo café da manhã especial" }],
  },
  ...
  { name: "Sushi Kaze", slug: "sushi-kaze", segment: "Restaurante Japonês", description: "Culinária japonesa autêntica com peixes frescos importados.", store_type: "MISTA", color: "B71C1C",
    offers: [{ title: "Combo 30 peças por R$69,90", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 70, image_url: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400&h=300&fit=crop", description: "Combinado especial com 30 peças variadas" }],
    catalog: [
  ...
  { name: "Café Aroma", slug: "cafe-aroma", segment: "Cafeteria", description: "Cafés especiais, cappuccinos artesanais e doces finos.", store_type: "RECEPTORA", color: "4E342E",
    offers: [{ title: "Cappuccino + brownie R$16,90", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 18, image_url: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop", description: "Combo perfeito para a tarde" }],
  },
  ...
  { name: "Ótica VisionPlus", slug: "otica-visionplus", segment: "Ótica", description: "Óculos de grau e sol das melhores marcas com exame gratuito.", store_type: "RECEPTORA", color: "1565C0",
    offers: [{ title: "Exame de vista gratuito", coupon_type: "STORE", discount_percent: 100, value_rescue: 100, image_url: "https://images.unsplash.com/photo-1574258495973-f7977603b6d2?w=400&h=300&fit=crop", description: "Exame completo grátis na compra de armação" }],
  },
  { name: "LavandeRia Express", slug: "lavanderia-express", segment: "Lavanderia", description: "Lavagem a seco, passadoria e entrega em domicílio.", store_type: "RECEPTORA", color: "0097A7",
    offers: [{ title: "1ª lavagem com 30% OFF", coupon_type: "STORE", discount_percent: 30, value_rescue: 40, image_url: "https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?w=400&h=300&fit=crop", description: "Desconto para novos clientes" }],
  },
  { name: "Auto Center Mestre", slug: "auto-center-mestre", segment: "Oficina Mecânica", description: "Revisão completa, troca de óleo, pneus e diagnóstico eletrônico.", store_type: "RECEPTORA", color: "546E7A",
    offers: [{ title: "Revisão + troca de óleo R$149", coupon_type: "PRODUCT", discount_percent: 25, value_rescue: 150, image_url: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=400&h=300&fit=crop", description: "Revisão completa com troca de óleo inclusa" }],
  },
  { name: "Flora & Jardim", slug: "flora-e-jardim", segment: "Floricultura", description: "Arranjos florais, plantas ornamentais e decoração para eventos.", store_type: "RECEPTORA", color: "43A047",
    offers: [{ title: "Buquê de rosas por R$49,90", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 50, image_url: "https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=400&h=300&fit=crop", description: "Buquê com 12 rosas vermelhas" }],
  },
  { name: "Livraria Palavra Viva", slug: "livraria-palavra-viva", segment: "Livraria", description: "Best-sellers, clássicos, HQs e papelaria fina.", store_type: "RECEPTORA", color: "6D4C41",
    offers: [{ title: "Leve 3 pague 2 em livros", coupon_type: "STORE", discount_percent: 33, value_rescue: 50, image_url: "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=400&h=300&fit=crop", description: "Promoção especial em títulos selecionados" }],
  },
  { name: "Papelaria Criativa", slug: "papelaria-criativa", segment: "Papelaria", description: "Material escolar, escritório, artesanato e presentes criativos.", store_type: "RECEPTORA", color: "FF7043",
    offers: [{ title: "Kit escolar com 15% OFF", coupon_type: "STORE", discount_percent: 15, value_rescue: 30, image_url: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=400&h=300&fit=crop", description: "Desconto no kit escolar completo" }],
  },
  { name: "Açaí da Terra", slug: "acai-da-terra", segment: "Açaíteria", description: "Açaí puro do Pará com frutas frescas e complementos premium.", store_type: "MISTA", color: "4A148C",
    offers: [{ title: "Açaí 500ml + complemento grátis", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 22, image_url: "https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?w=400&h=300&fit=crop", description: "Açaí cremoso com 1 complemento por conta da casa" }],
    catalog: [
  ...
  { name: "Cervejaria Hop Lab", slug: "cervejaria-hop-lab", segment: "Cervejaria", description: "Cervejas artesanais de fabricação própria com estilos variados.", store_type: "EMISSORA", color: "E65100",
    offers: [{ title: "Pint artesanal por R$14,90", coupon_type: "PRODUCT", discount_percent: 25, value_rescue: 15, image_url: "https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=400&h=300&fit=crop", description: "Qualquer estilo de cerveja artesanal" }],
    catalog: [
  ...
  { name: "Doce Mania", slug: "doce-mania", segment: "Doceria", description: "Brigadeiros gourmet, bolos decorados e doces finos para festas.", store_type: "RECEPTORA", color: "F06292",
    offers: [{ title: "Caixa 25 brigadeiros R$39,90", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 40, image_url: "https://images.unsplash.com/photo-1558326567-98ae2405596b?w=400&h=300&fit=crop", description: "Brigadeiros gourmet sortidos" }],
  },
  ...
  { name: "OdontoSmile", slug: "odontosmile", segment: "Dentista", description: "Clínica odontológica com clareamento, implantes e ortodontia.", store_type: "RECEPTORA", color: "00838F",
    offers: [{ title: "Avaliação + limpeza gratuita", coupon_type: "STORE", discount_percent: 100, value_rescue: 120, image_url: "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=400&h=300&fit=crop", description: "Primeira consulta e limpeza sem custo" }],
  },
  { name: "Studio Hair", slug: "studio-hair", segment: "Salão de Beleza", description: "Cortes, coloração, hidratação e tratamentos capilares.", store_type: "RECEPTORA", color: "C62828",
    offers: [{ title: "Escova + hidratação R$59", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 60, image_url: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=400&h=300&fit=crop", description: "Escova modelada com hidratação profunda" }],
  },
  { name: "Mercadinho Bom Preço", slug: "mercadinho-bom-preco", segment: "Mercadinho", description: "Hortifruti frescos, carnes selecionadas e produtos do dia a dia.", store_type: "EMISSORA", color: "2E7D32",
    offers: [{ title: "5% OFF acima de R$100", coupon_type: "STORE", discount_percent: 5, value_rescue: 15, image_url: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=400&h=300&fit=crop", description: "Desconto em compras acima de R$100" }],
  ...
  { name: "Pé de Ouro", slug: "pe-de-ouro", segment: "Loja de Calçados", description: "Calçados femininos, masculinos e infantis das melhores marcas.", store_type: "RECEPTORA", color: "5D4037",
    offers: [{ title: "2º par com 50% OFF", coupon_type: "STORE", discount_percent: 50, value_rescue: 80, image_url: "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=400&h=300&fit=crop", description: "Compre um par e ganhe 50% no segundo" }],
  },
  { name: "Casa de Carnes Nobre", slug: "casa-de-carnes-nobre", segment: "Casa de Carnes", description: "Carnes premium, cortes especiais e embutidos artesanais.", store_type: "RECEPTORA", color: "BF360C",
    offers: [{ title: "Kit Churrasco R$89,90", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 90, image_url: "https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=400&h=300&fit=crop", description: "Kit completo para churrasco de 10 pessoas" }],
  },
  { name: "TechStore", slug: "techstore", segment: "Loja de Eletrônicos", description: "Smartphones, notebooks, acessórios e assistência técnica.", store_type: "RECEPTORA", color: "1A237E",
    offers: [{ title: "10% OFF em acessórios", coupon_type: "STORE", discount_percent: 10, value_rescue: 50, image_url: "https://images.unsplash.com/photo-1468495244123-6c6c332eeece?w=400&h=300&fit=crop", description: "Desconto em capas, fones e carregadores" }],
  },
  { name: "Trattoria Italiana", slug: "trattoria-italiana", segment: "Restaurante Italiano", description: "Massas frescas, risotos cremosos e vinhos italianos selecionados.", store_type: "MISTA", color: "C62828",
    offers: [{ title: "Massa + vinho por R$59,90", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 60, image_url: "https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&h=300&fit=crop", description: "Qualquer massa com taça de vinho" }],
    catalog: [
  ...
  { name: "Churrascaria Fogo Nobre", slug: "churrascaria-fogo-nobre", segment: "Churrascaria", description: "Rodízio completo de carnes nobres com buffet de saladas.", store_type: "RECEPTORA", color: "DD2C00",
    offers: [{ title: "Rodízio por R$59,90/pessoa", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 60, image_url: "https://images.unsplash.com/photo-1558030006-450675393462?w=400&h=300&fit=crop", description: "Rodízio completo com sobremesa inclusa" }],
  },
  { name: "Brink Kids", slug: "brink-kids", segment: "Loja de Brinquedos", description: "Brinquedos educativos, jogos de tabuleiro e diversão garantida.", store_type: "RECEPTORA", color: "FF6F00",
    offers: [{ title: "20% OFF em jogos", coupon_type: "STORE", discount_percent: 20, value_rescue: 40, image_url: "https://images.unsplash.com/photo-1558060370-d644479cb6f7?w=400&h=300&fit=crop", description: "Desconto em jogos de tabuleiro e cartas" }],
  },
  { name: "Beleza Natural", slug: "beleza-natural", segment: "Loja de Cosméticos", description: "Maquiagem, skincare, perfumes e produtos de beleza importados.", store_type: "RECEPTORA", color: "880E4F",
    offers: [{ title: "Kit Skincare com 25% OFF", coupon_type: "PRODUCT", discount_percent: 25, value_rescue: 70, image_url: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=300&fit=crop", description: "Kit limpeza + hidratante + protetor solar" }],
  },
  { name: "Ink Masters", slug: "ink-masters", segment: "Estúdio de Tatuagem", description: "Tatuagens artísticas, coberturas e piercings com profissionais premiados.", store_type: "RECEPTORA", color: "212121",
    offers: [{ title: "Flash tattoo por R$150", coupon_type: "PRODUCT", discount_percent: 30, value_rescue: 150, image_url: "https://images.unsplash.com/photo-1590246814883-57764a8a0d4a?w=400&h=300&fit=crop", description: "Tatuagens de designs prontos do estúdio" }],
  },
  { name: "English Now", slug: "english-now", segment: "Escola de Idiomas", description: "Cursos de inglês, espanhol e francês para todas as idades.", store_type: "EMISSORA", color: "0D47A1",
    offers: [{ title: "Aula experimental grátis", coupon_type: "STORE", discount_percent: 100, value_rescue: 50, image_url: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=400&h=300&fit=crop", description: "1 aula experimental sem compromisso" }],
    catalog: [
  ...
  { name: "Power Suplementos", slug: "power-suplementos", segment: "Loja de Suplementos", description: "Whey protein, creatina, BCAA e suplementos das melhores marcas.", store_type: "RECEPTORA", color: "F57F17",
    offers: [{ title: "Whey 1kg com 10% OFF", coupon_type: "PRODUCT", discount_percent: 10, value_rescue: 25, image_url: "https://images.unsplash.com/photo-1593095948071-474c5cc2c4d8?w=400&h=300&fit=crop", description: "Whey Protein concentrado 1kg" }],
  },
  { name: "Adega Bacchus", slug: "adega-bacchus", segment: "Loja de Vinhos", description: "Vinhos nacionais e importados, espumantes e destilados premium.", store_type: "RECEPTORA", color: "4A148C",
    offers: [{ title: "2 vinhos por R$99,90", coupon_type: "PRODUCT", discount_percent: 25, value_rescue: 100, image_url: "https://images.unsplash.com/photo-1474722883778-792e7990302f?w=400&h=300&fit=crop", description: "Seleção especial de vinhos tintos e brancos" }],
  },
  { name: "Verde Vegan", slug: "verde-vegan", segment: "Restaurante Vegano", description: "Culinária vegana criativa com ingredientes orgânicos e locais.", store_type: "MISTA", color: "33691E",
    offers: [{ title: "Prato executivo R$24,90", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 25, image_url: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", description: "Prato do dia com entrada e sobremesa" }],
    catalog: [
  ...
  { name: "Pastelão do Zé", slug: "pastelao-do-ze", segment: "Pastelaria", description: "Pastéis gigantes crocantes com recheios tradicionais e especiais.", store_type: "RECEPTORA", color: "E65100",
    offers: [{ title: "Pastel + caldo de cana R$12", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 12, image_url: "https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&h=300&fit=crop", description: "Combo tradicional de feira" }],
  },
  { name: "Cell Fix", slug: "cell-fix", segment: "Loja de Celulares", description: "Assistência técnica, capas, películas e acessórios para celular.", store_type: "RECEPTORA", color: "263238",
    offers: [{ title: "Troca de tela com 15% OFF", coupon_type: "PRODUCT", discount_percent: 15, value_rescue: 60, image_url: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=300&fit=crop", description: "Reparo de tela para qualquer modelo" }],
  },
  { name: "Confeitaria Doce Sonho", slug: "confeitaria-doce-sonho", segment: "Confeitaria", description: "Bolos personalizados, tortas e doces finos para festas e eventos.", store_type: "RECEPTORA", color: "D81B60",
    offers: [{ title: "Bolo festa 3kg por R$129", coupon_type: "PRODUCT", discount_percent: 20, value_rescue: 130, image_url: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&h=300&fit=crop", description: "Bolo decorado para até 30 pessoas" }],
  },
  ...
  try {
    ...
    const getOrCreateUser = async (email: string, password: string, fullName: string) => {
      ...
      if (createErr?.message?.includes("already been registered")) {
        const { data: ld } = await supabaseAdmin.auth.admin.listUsers();
        const existing = ld?.users?.find((u: any) => u.email === email);
    ...
    // ─── 1. Create Owner User ────────────────────────────────────
    const ownerUser = await getOrCreateUser(owner_email, owner_password, owner_name);
    ...
    // ─── 6. Assign brand_admin role to owner ─────────────────────
    ...
    // Admin test account (separate from owner)
    const adminEmail = `teste-${emailPrefix}@teste.com`;
    const adminUser = await getOrCreateUser(adminEmail, "123456", `Admin ${company_name}`);
    ...
    // Customer test account with 1000 points
    const customerEmail = `cliente-${emailPrefix}@teste.com`;
    const customerUser = await getOrCreateUser(customerEmail, "123456", "Cliente Teste");
    ...
    const storeUser = await getOrCreateUser(storeEmail, "123456", "Loja Teste");
    ...
    for (const demo of DEMO_STORES) {
      ...
      // Create catalog items for EMISSORA/MISTA
    ...
    const franqueadoUser = await getOrCreateUser(franqueadoEmail, "123456", "Franqueado Teste");
