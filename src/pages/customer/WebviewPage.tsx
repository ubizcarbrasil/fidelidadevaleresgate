...
/**
 * WebviewSkeleton — placeholder ultraleve renderizado imediatamente
 * para dar feedback visual enquanto o iframe ainda baixa/parseia.
 * Usa apenas divs + animate-pulse, sem dependências externas.
 */
const shimmer = "animate-pulse rounded bg-muted";
const WebviewSkeleton = () => (
  <div className="absolute inset-0 z-10 flex flex-col gap-4 p-4 bg-background overflow-hidden">
