...
const journeySteps: JourneyStep[] = [
  {
    ...
    steps: [
      ...
      "Preencha o slug (identificador único, ex: 'vale-resgate-gyn').",
      "Clique em 'Salvar'.",
    ],
    tips: [
      "O slug é usado internamente para organizar dados. Use letras minúsculas e hífens.",
  ...
  },
  {
    ...
    description: "O wizard cria automaticamente: Marca, Cidade, Domínio e Usuários de teste.",
    route: "/provision-brand",
    steps: [
      "Acesse o menu lateral → Estrutura → Nova Empresa.",
      "Selecione a empresa (Tenant) criada no passo anterior.",
      "Preencha o nome da marca (ex: 'Vale Resgate Goiânia').",
      "Defina o slug da marca (ex: 'vale-resgate-gyn').",
      "Preencha o nome da primeira cidade (ex: 'Goiânia Centro').",
      "Defina o subdomínio (ex: 'gyn') — será acessível em gyn.seudominio.com.",
      "Faça upload do logotipo e configure as cores da marca.",
      "Clique em 'Provisionar' e aguarde a criação automática.",
    ],
    tips: [
      "O wizard cria automaticamente 3 contas de teste: Admin, Cliente (com 1000 pontos) e Parceiro. Senha padrão: 123456.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Configure o template de Home Page padrão que será aplicado automaticamente.",
      "Defina as categorias e segmentos padrão para parceiros.",
      "Configure as regras de pontos padrão.",
      "Salve as configurações.",
    ],
    tips: [
      "O Kit Inicial é aplicado toda vez que uma nova marca é provisionada.",
  ...
  },
  {
    ...
    route: "/modules",
    steps: [
      "Acesse → Plataforma → Funcionalidades para ver todos os módulos disponíveis.",
      "Acesse → Usuários & Permissões → Módulos da Marca para ativar/desativar módulos por marca.",
      "Configure Permissões por Empresa em → Usuários & Permissões → Permissões por Empresa.",
      "Defina quais ações os parceiros podem realizar (criar ofertas, emitir pontos, etc.).",
    ],
    tips: [
      "Módulos desativados escondem automaticamente os menus correspondentes no painel do empreendedor.",
      "Use o transbordo de permissões para definir o que cada nível pode fazer.",
    ],
  },
  {
    id: "5",
    ...
    route: "/branches",
    steps: [
      "Acesse → Estrutura → Cidades.",
      "A cidade principal já foi criada pelo wizard. Para adicionar mais, clique em 'Nova Cidade'.",
      "Preencha: nome, slug, cidade, estado, localização geográfica e fuso horário.",
      "Ative ou desative cidades conforme a operação do empreendedor.",
    ],
    tips: [
      "Cada cidade pode ter suas próprias regras de pontos.",
      "Use 'Clonar Cidade' para duplicar configurações de uma cidade existente.",
    ],
  },
  {
    id: "6",
