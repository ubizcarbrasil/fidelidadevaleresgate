...
import { ScanLine, CheckCircle2, XCircle, Loader2, KeyRound } from "lucide-react";
...
export default function StoreRedeemTab({ store }: { store: any }) {
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Resgate de PIN</h1>
        <p className="text-sm text-muted-foreground">Valide o PIN + CPF do cliente para confirmar o resgate</p>
      </div>

      <Card className="rounded-2xl">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            <KeyRound className="h-5 w-5" /> Buscar Resgate
          </CardTitle>
        </CardHeader>
