...
export default function BranchSelector() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-5" style={{ backgroundColor: "#FAFAFA" }}>
      <div
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-sm mt-1" style={{ color: `${fg}50` }}>
            {displayName}
          </p>
        </div>
        ...
        <div className="relative py-2 mb-4">
          <div className="absolute inset-0 flex items-center">
            <span className="w-full" style={{ borderTop: `1px solid ${fg}10` }} />
          </div>
          <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-wider">
            <span className="bg-white px-3" style={{ color: `${fg}30` }}>ou escolha</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {branches.map((branch) => (
            <button
              ...
              className="w-full flex items-center gap-3 rounded-[14px] p-3.5 text-left transition-all"
              style={{
            ...
            >
              ...
              <div className="min-w-0">
                ...
                {(branch.city || branch.state) && (
                  <div className="text-xs" style={{ color: `${fg}45` }}>
