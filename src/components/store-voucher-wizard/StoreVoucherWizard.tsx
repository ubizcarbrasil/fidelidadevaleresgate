...
export default function StoreVoucherWizard({ storeId, branchId, brandId, editOffer, onClose }: Props) {
  ...
  const buildInitialData = (): StoreVoucherData => {
    ...
    return {
      ...
      unlimited_total: editOffer.max_total_uses === null || editOffer.max_total_uses === undefined,
      max_uses_per_customer: editOffer.max_uses_per_customer,
      unlimited_per_customer: editOffer.max_uses_per_customer === null || editOffer.max_uses_per_customer === undefined,
