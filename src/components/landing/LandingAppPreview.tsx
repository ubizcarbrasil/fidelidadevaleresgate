  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative mx-auto w-[220px] md:w-[250px]">
        <div className="rounded-[2rem] border-[5px] border-white/20 bg-[hsl(160,30%,10%)] shadow-2xl overflow-hidden">
        ...
        <div className="absolute -inset-4 bg-emerald-500/5 rounded-[3rem] blur-2xl -z-10" />
      </div>
...
function ScreenHome() {
  return (
    <div className="bg-gradient-to-b from-emerald-500/10 to-[hsl(160,30%,10%)] p-4 h-full flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[10px] text-white/50">Olá,</p>
          <p className="text-sm font-bold text-white">Maria Silva</p>
        </div>
        <div className="h-8 w-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-xs font-bold text-emerald-400">MS</div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {["Ofertas", "Carteira", "Lojas"].map((a) => (
          <div key={a} className="rounded-lg bg-white/5 border border-white/10 p-2 text-center">
            <div className="h-5 w-5 rounded-md bg-emerald-500/15 mx-auto mb-1" />
      ...
      <div>
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex items-center gap-2 mb-2">
            <div className="h-9 w-9 rounded-lg bg-emerald-500/10 shrink-0" />
            <div className="flex-1">
              <div className="h-2 w-16 rounded bg-white/10 mb-1" />
              <div className="h-2 w-10 rounded bg-white/5" />
            </div>
            <div className="rounded-full bg-emerald-500/15 px-2 py-0.5">
              <span className="text-[8px] font-bold text-emerald-400">20% OFF</span>
            </div>
          </div>
        ))}
      </div>
...
function ScreenOffers() {
  ...
  return (
    <div className="bg-[hsl(160,30%,10%)] p-4 h-full flex flex-col gap-3">
...
function ScreenWallet() {
  ...
  return (
    <div className="bg-[hsl(160,30%,10%)] p-4 h-full flex flex-col gap-3">
      ...
      <div className="rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-4 text-white text-center">
      ...
      <div className="flex flex-col gap-2 flex-1">
        {history.map((h, i) => (
          <div key={i} className="flex items-center justify-between rounded-lg border border-white/10 p-2.5 bg-white/[0.03]">
            ...
            <span className={`text-[10px] font-bold ${h.positive ? "text-emerald-400" : "text-red-400"}`}>{h.pts}</span>
          </div>
        ))}
      </div>
    </div>
...
export default function LandingAppPreview() {
  return (
    <section className="py-20 md:py-28 bg-[hsl(160,30%,8%)] relative overflow-hidden">
      <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-emerald-500/5 rounded-full blur-[80px]" />
