import {
  ...
  Coins, Sparkles, PackageSearch, BarChart3, Bell, ScanLine, Shield, FolderTree, Zap, Rocket, Key, BookOpen, Eye, TrendingUp, Crown,
  ClipboardList, ChevronRight, Car, FlaskConical, LayoutTemplate,
} from "lucide-react";
